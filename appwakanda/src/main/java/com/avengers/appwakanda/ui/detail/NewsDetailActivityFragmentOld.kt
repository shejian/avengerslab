 ...
 * @Date 2018-07-18
 */
class NewsDetailActivityFragmentOld : Fragment() {

    var newsDetailVM: NewsDetailViewModel? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        newsDetailVM = ViewModelProviders
                .of(this,NewsDetailViewModel.VMFactory(repository))
        ...
        var newsDetailBinding = DataBindingUtil
                ...
                .apply {
                 ...
                 //   handlerClick = HandlerClick()
                    ...
                    setLifecycleOwner(this@NewsDetailActivityFragmentOld)
                }
        //7.设置参数，发送请求
