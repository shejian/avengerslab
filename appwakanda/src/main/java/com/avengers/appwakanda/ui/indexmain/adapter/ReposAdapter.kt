 ...
 */
class ReposAdapter : ListAdapter<ContextItemEntity, RecyclerView.ViewHolder>(REPO_COMPARATOR) {
    ...
    companion object {
        private val REPO_COMPARATOR = object : DiffUtil.ItemCallback<ContextItemEntity>() {
